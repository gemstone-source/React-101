...
function Header() {
  ...
  return (
    <header className="header">
      <h1 style={style}>Gems Fast Food Co.</h1>
    </header>
  );
}
  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <>
          <p>
            Authentic Delicious Fast food with great Ingredients from Mbeya.
            region. All from our stone oven, all organic, all delicious.
          </p>
          <ul className="pizzas">
            {pizzas.map((pizza) => (
